<?php 
   ...
   if(!empty($item_cats) && !is_wp_error($item_cats)){
      foreach((array)$item_cats as $item_cat){
         ...
         $output .= '<a href="'.get_category_link( $item_cat->term_id ).'" title="' . esc_attr( sprintf( esc_html__( "View all posts in %s", 'kiamo' ), $item_cat->name ) ) . '">'.$item_cat->name.'</a>'.$separator;
      }
   ...
   <div class="portfolio-block portfolio-item-v2 isotope-item margin-bottom-30">      
      <div class="portfolio-content">
         ...
         <div class="content-inner">
            ...
            <div class="summary"><?php echo kiamo_limit_words( 20, get_the_excerpt(), get_the_content() ); ?></div>
         </div>
      </div>
   </div>
</div>