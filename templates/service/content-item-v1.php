   ...
   <div class="service-block service-item-v1">      
      ...
      <div class="service-content">
         <div class="content-inner">
            ...
            <div class="desc"><?php echo kiamo_limit_words($excerpt_words, get_the_excerpt(), get_the_content()); ?></div> 
            <div class="readmore"><a class="btn-theme" href="<?php the_permalink(); ?>"><?php echo esc_html__('Read more', 'kiamo') ?></a></div>
         </div>    
      </div>
   </div>
</div>