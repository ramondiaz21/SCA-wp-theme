...
<head>
  ...
  <script>
    window.markerConfig = {
      project: '66108baa423688c461876d3c', 
      source: 'snippet'
    };
              ...
              <div class="row">
                ...
                <div class="logo col-lg-2 col-md-2">
                  <a class="logo-theme" href="<?php echo esc_url( home_url( '/' ) ); ?>">
                    <img src="<?php echo ((isset($kiamo_options['header_logo']['url']) && $kiamo_options['header_logo']['url']) ? $kiamo_options['header_logo']['url'] : get_template_directory_uri().'/images/logo-white.png'); ?>" alt="<?php bloginfo( 'name' ); ?>" />
                  </a>
                </div>
