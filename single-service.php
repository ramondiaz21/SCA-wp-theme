 ...
 */
    ...
    $default_sidebar_config = kiamo_get_option('single_service_sidebar', 'right-sidebar'); 
    $default_left_sidebar = kiamo_get_option('single_service_left_sidebar', 'blog_sidebar');
    $default_right_sidebar = kiamo_get_option('single_service_right_sidebar', 'blog_sidebar');
        ...
        <div class="content-page <?php echo esc_attr($main_content_config['class']); ?>">      
          <div id="wp-content" class="wp-content clearfix">
            <?php while ( have_posts() ) : the_post(); 
              get_template_part( 'templates/service/content', 'single' ); 
            endwhile; ?>  
