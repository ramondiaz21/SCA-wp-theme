<?php 
  get_header(apply_filters('kiamo_get_header_layout', null )); 
   wp_enqueue_script( 'vc_waypoints', vc_asset_url( 'lib/vc_waypoints/vc-waypoints.min.js' ), array( 'jquery-core' ), WPB_VC_VERSION, true );
    ...
    <div class="main-page-content row">
      ...
      <div class="content-page col-xs-12">      
        <?php while ( have_posts() ) : the_post(); ?>
          <?php
            $team_position = get_post_meta(get_the_id(), 'kiamo_team_position', true );
            ...
            $team_quote = get_post_meta(get_the_id(), 'kiamo_team_quote', true );
            $team_email = get_post_meta(get_the_id(), 'kiamo_team_email', true );
            $team_phone = get_post_meta(get_the_id(), 'kiamo_team_phone', true );
            $team_address = get_post_meta(get_the_id(), 'kiamo_team_address', true );
          ...
          <div class="team-block-single clearfix single">
            <div class="col-md-3 col-sm-3 col-xs-12 team-image">
              <div class=" team-thumbnail">
                ...
                <div class="heading"><?php echo esc_html__('Contact Info', 'kiamo') ?></div>
                <div class="team-email"><?php echo esc_html('Email: ') ?><?php echo esc_html( $team_email ) ?></div>
                <div class="team-phone"><?php echo esc_html('Phone: ') ?><?php echo esc_html( $team_phone ) ?></div>
                <?php if($team_socials){ ?>
                  <div class="socials">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              ...
              <?php if( is_array($team_educations) && isset($team_educations[1]) ){ ?>
                <div class="team-educations">
                  <div class="heading"><?php echo esc_html__('Educations', 'kiamo') ?></div>
              ...
              <?php if( is_array($team_skills) && isset($team_skills[1]) ){ ?>
                <div class="team-skills clearfix">
                  <div class="heading"><?php echo esc_html__('Skills', 'kiamo') ?></div>
