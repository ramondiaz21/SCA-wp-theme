 ...
 */
	...
	<footer id="wp-footer" class="clearfix">
		<?php $footer = apply_filters('kiamo_get_footer_layout', null ); $footer;  ?>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8 col-xs-12">
						<?php echo kiamo_get_option('copyright_text', esc_html__('Copyright ', 'kiamo') . date('Y') . ' - ' . esc_html__('Company - All rights reserved. Powered by WordPress.', 'kiamo') ); ?>
					</div>
