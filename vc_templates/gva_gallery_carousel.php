...
<div class="widget gva-gallery-carousel <?php echo esc_attr($el_class); ?>">
  <div class="widget-content">
    <div class="owl-carousel init-carousel-owl slider-gallery-v1" <?php echo kiamo_set_carousel_attrs($carousel_attrs) ?> data-items="2" data-items_lg="2" data-items_md="2" data-items_sm="1" data-items_xs="1">
      <?php 
        $i = 0;
        if ( $query->have_posts() ) :
