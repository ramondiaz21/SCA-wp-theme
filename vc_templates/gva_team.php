  ...
  <div class="row">
    <div class="col-lg-6 col-md-6">
      <div class="team-header">
        <img alt="<?php echo esc_html($name); ?>" src="<?php echo esc_url_raw($image); ?>" class="img-responsive"> 
        <div class="box-hover">
...
<div class="widget gsc-team team-vertical-small <?php echo esc_attr($style) ?> <?php echo esc_attr($el_class) ?>">
  <div class="widget-content text-center">
    <div class="team-header text-center margin-bottom-10">
      <img alt="<?php echo esc_html($name); ?>" src="<?php echo esc_url($image) ?>" class="img-responsive"> 
    </div> 
    <div class="team-body">
      <div class="team-body-content">
        <h3 class="team-name">
