...
<div class="widget gsc-our-partners <?php echo esc_attr($el_class) ?>">
   <?php if($image){ ?>
      <div class="image"><img src="<?php echo esc_url($image) ?>" alt="<?php echo esc_html($title); ?>"/></div>
   <?php } ?>
   <div class="content-inner">
      <?php if($title){ ?>
         <div class="title">
            <?php if($link){ ?><a href="<?php echo esc_url($link) ?>" <?php print $target ?>><?php } ?> 
      ...
      <?php if($content){ ?>
         <div class="content"><?php print esc_html($content) ?></div>
      <?php } ?>                       
   </div>
</div>
