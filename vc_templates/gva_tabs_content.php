...
<div class="gsc-tabs-content <?php echo esc_attr($el_class) ?> slick-tabs" data-slick-id = "<?php print $_id ?>"> 
    ...
    <div class="tab-carousel-nav slick-slider nav-<?php print $_id ?>">
      <?php foreach( $line_data as $data ): ?>
        <div class="slick-slide">
          <div class="item">
            <a>
              <?php if($data['icon']){ ?><i class="<?php print esc_attr($data['icon']) ?>"></i><?php } ?>
      ...
      <?php foreach( $line_data as $data ): ?>
        <div class="slick-slide">
           <div class="item">
              ...
              ?> 
                <div class="images"><img src="<?php echo esc_url($image) ?>" alt="<?php echo esc_html($data['title']) ?>"></div>
              <?php } ?>
