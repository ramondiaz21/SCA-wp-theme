 ...
 */
	...
	$sidebar_layout_config = kiamo_get_option('archive_post_sidebar', ''); 
  $left_sidebar = kiamo_get_option('archive_post_left_sidebar', '');  
  $right_sidebar = kiamo_get_option('archive_post_right_sidebar', ''); 
